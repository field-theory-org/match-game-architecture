...
class MatchGameUI {
    ...
    ///
    /// - returns: A tuple of the desired starting number of matches,
    ///            the maximum number of matches to remove and the
    ///            desired strategy (1: Dumb, 2: Wild, 3: Smart).
    ///            Invalid values are returned as 0.
