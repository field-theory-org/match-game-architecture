...
//
//  Modified for educational use by Wolfram Schroers <Wolfram.Schroers@field-theory.org> on 5/30/2016.
...
extension UISegmentedControl {
    public var rac_selectedSegmentIndex: MutableProperty<Int> {
        return lazyMutableProperty(self,
                                   key: &AssociationKey.selectedSegmentIndex,
                                   setter: { self.selectedSegmentIndex = $0 },
                                   getter: { self.selectedSegmentIndex })
    }
}
